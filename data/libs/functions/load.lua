...
dofile(CORE_DIRECTORY .. "/libs/functions/instance_registry.lua")
...
dofile(CORE_DIRECTORY .. "/libs/functions/hunt_instance.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/wiki_hunts_import.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/raid_instance.lua")
